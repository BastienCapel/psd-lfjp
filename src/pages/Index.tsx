...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col font-raleway">
      ...
      <Hero 
        title="Lycée Français Jacques Prévert" 
        subtitle="Excellence, Respect, Créativité, Persévérance, Civisme" 
      />
      
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-playfair font-bold text-french-blue mb-12 text-center">
            Bienvenue sur le site du Lycée Français Jacques Prévert
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8">
                ...
                <Link to="/vision-missions-valeurs" className="inline-flex items-center text-french-blue font-medium hover:underline">
                  Découvrir 
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-8">
                ...
                <Link to="/plan-strategique" className="inline-flex items-center text-french-blue font-medium hover:underline">
                  Consulter 
                  <ArrowRight size={16} className="ml-2" />
                </Link>
              </CardContent>
