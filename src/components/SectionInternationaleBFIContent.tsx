...
const SectionInternationaleBFIContent = () => {
  ...
  const objectives = ["Mise en place progressive et maîtrisée de la SI", "Gestion optimisée des ressources humaines", "Viabilité économique du dispositif", "Garantie de la qualité pédagogique"];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="mb-8 border-french-blue/10 shadow-md">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {keyIndicators.map((indicator, index) => <div key={index} className="text-center p-4 bg-white rounded-lg border border-gray-100">
          ...
          <Card className="mb-8 border-french-blue/10 shadow-md">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {objectives.map((objective, index) => <div key={index} className="flex items-start space-x-3">
          ...
          <Card className="mb-8 border-french-blue/10 shadow-md">
            ...
            <CardContent>
              <div className="space-y-4">
                {deploymentPhases.map((phase, index) => <div key={index} className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100">
          ...
          <Card className="mb-8 border-french-blue/10 shadow-md">
            ...
            <CardContent>
              <div className="space-y-4">
                {criticalThresholds.map((threshold, index) => <div key={index} className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
