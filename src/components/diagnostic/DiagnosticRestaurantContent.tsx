...
const DiagnosticRestaurantContent = () => {
  ...
  // Points d'attention
  const alertPoints = [
    { name: "Mercredi", value: "36.3%", label: "d'intérêt seulement (vs +80% autres jours)" },
    { name: "Options alimentaires spécifiques", value: "33.3%", label: "demandent l'option végétarienne" },
    { name: "Tarification", value: "58.8%", label: "acceptent 2000-3000 FCFA pour un menu complet" }
  ];
